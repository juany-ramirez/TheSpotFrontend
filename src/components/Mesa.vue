  ...
  <div id="root">
    ...
    <table class="table centered">
      <thead>
        <tr>
          <th>Nombre</th>
          <th>Tipo</th>
          <th>Ver/Modificar Ingredientes</th>
          <th>Modificar</th>
          <th>Borrar</th>
        </tr>
      </thead>
      <tbody>
        <tr v-for="bebida in bebidas">
          ...
          <td >{{bebida.tipo}}</td>
          <td>
            <a v-on:click="verIngredientes(bebida)" class="btn-floating btn-small waves-effect waves-light grey darken-4"><i class="material-icons">restaurant_menu</i></a>
          </td>
          <td>
    ...
    <div class="row">
        ...
        <div class="row -white" id="contenedorTablaExterna">
          <div class="switch">
            <h5>Seleccionar ID Ingredien:</h5>
